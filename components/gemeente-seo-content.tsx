  ...
  return (
    <div className="bg-background">
      ...
      <section className="py-12 lg:py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 id={data.naam === "Den Haag" ? "haagse-faq" : data.naam === "Rotterdam" ? "rotterdam-faq" : data.naam === "Delft" ? "delft-faq" : data.naam === "Zoetermeer" ? "zoetermeer-faq" : data.naam === "Wassenaar" ? "wassenaar-faq" : data.naam === "Westland" ? "westland-faq" : data.naam === "Rijswijk" ? "rijswijk-faq" : data.naam === "Pijnacker-Nootdorp" ? "pijnacker-faq" : data.naam === "Leidschendam-Voorburg" ? "lv-faq" : data.naam === "Midden-Delfland" ? "midden-delfland-faq" : data.naam === "Schiedam" ? "schiedam-faq" : data.naam === "Vlaardingen" ? "vlaardingen-faq" : data.naam === "Capelle aan den IJssel" ? "capelle-faq" : data.naam === "Barendrecht" ? "barendrecht-faq" : data.naam === "Ridderkerk" ? "ridderkerk-faq" : data.naam === "Nissewaard" ? "nissewaard-faq" : data.naam === "Lansingerland" ? "lansingerland-faq" : data.naam === "Voorne aan Zee" ? "voorne-aan-zee-faq" : data.naam === "Albrandswaard" ? "albrandswaard-faq" : data.naam === "Krimpen aan den IJssel" ? "krimpen-faq" : data.naam === "Maassluis" ? "maassluis-faq" : data.naam === "Goeree-Overflakkee" ? "goeree-faq" : undefined} className="text-3xl lg:text-4xl font-bold text-foreground mb-8 text-center">
