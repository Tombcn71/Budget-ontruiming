      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link
            ...
            <span className="font-bold text-base lg:text-2xl text-foreground">
              Budget
            </span>
            <span className="font-normal text-base lg:text-2xl text-foreground">
              Ontruiming
            </span>
          </Link>
          <div className="flex items-center ml-auto gap-4 md:gap-8 lg:gap-10">
            ...
            <div className="flex items-center">
              <Button
                className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold text-sm lg:text-base px-4 sm:px-6"
                asChild>
                <a
