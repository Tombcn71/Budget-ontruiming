...
export default function NissewaardPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Ja, wij werken in heel Nissewaard: Spijkenisse en alle 7 dorpen waaronder Abbenbroek, Geervliet, Heenvliet, Hekelingen, Simonshaven, Zuidland en Oudenhoorn.",
    },
    {
      question: "Hebben jullie ervaring met hoogbouw in Spijkenisse?",
      answer:
        "Zeker, wij hebben veel ervaring met de specifieke logistiek van hoogbouw appartementen in Spijkenisse, inclusief liftgebruik en efficiënte afvoer.",
    },
    {
      question: "Hoe snel kunnen jullie een woning in Nissewaard ontruimen?",
      answer:
        "Meestal kunnen we binnen 1-3 werkdagen starten. Bij spoedgevallen in Nissewaard kunnen we vaak binnen 24 uur beginnen.",
    },
    {
      question: "Wat is de laagste prijs garantie in Nissewaard?",
      answer:
  ...
  // Waarom kiezen
  const waaromKiezen = [
    "Expertise in hoogbouwlogistiek binnen de stad Spijkenisse",
    "Volledige dekking van het buitengebied en de dorpskernen (Bernisse-regio)",
  ...
  const situaties = [
    {
      title: "Hoogbouw appartement ontruimen Spijkenisse",
      description:
        "Spijkenisse kent veel hoogbouw. Wij hebben ervaring met de specifieke logistiek van hoogbouw appartementen, inclusief liftgebruik en efficiënte afvoer.",
    },
    {
      title: "Huurwoning bezemschoon opleveren",
      description:
        "Voor woningcorporaties in Nissewaard leveren wij bezemschoon op volgens de strikte oplevervoorwaarden. Geen discussie bij de eindoplevering.",
    },
    {
      title: "Seniorenverhuizing Spijkenisse",
      description:
        "Bij verhuizing naar een zorginstelling begeleiden wij u volledig en ontruimen we de oude woning compleet. Ook in de dorpen.",
    },
    {
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative min-h-[500px] lg:min-h-[600px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt="Professionele woningontruiming Nissewaard"
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="text-2xl sm:text-3xl lg:text-6xl font-bold text-white mb-3 lg:mb-6 leading-tight text-balance">
                  Woningontruiming Nissewaard, met laagste prijs garantie.
                </h1>
                ...
                <div className="inline-block bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full mb-4">
                  <p className="text-md sm:text-lg font-semibold text-white">
                    🏆 Laagste Prijs Garantie in Nissewaard
                  </p>
                </div>
          ...
          <section className="py-12 lg:py-16 bg-muted/30 mb-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-8 text-center">
                Waarom kiezen voor Budget Ontruiming in Nissewaard?
              </h2>
        ...
        {/* FAQ Section */}
        <section id="nissewaard-faq" className="bg-muted/50 py-12 lg:py-16">
          <div className="container mx-auto px-4">
        ...
        {/* GemeenteMap */}
        <GemeenteMap gemeenteNaam="Nissewaard" postcodes="3200-3209" />
