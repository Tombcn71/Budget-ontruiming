...
export const metadata: Metadata = {
  ...
  keywords: "woningontruiming haaglanden, woningontruiming rijnmond, ontruiming den haag, ontruiming rotterdam, bezemschoon, spoedontruiming, laagste prijs garantie",
  openGraph: {
    title: "Budget Ontruiming | Laagste Prijs Garantie voor Woningontruiming",
    description: "Vindt u het elders goedkoper? Wij duiken onder die prijs! Actief in Den Haag, Rotterdam en 20+ gemeentes.",
  ...
  twitter: {
    ...
    description: "Woningontruiming met AI-prijscalculator. Start binnen 24 uur mogelijk.",
  },
  alternates: {
...
export default function Home() {
  ...
  const gemeentes = [
    "Den Haag", "Rotterdam", "Delft", "Zoetermeer", "Schiedam", "Vlaardingen",
    "Rijswijk", "Wassenaar", "Westland", "Leidschendam-Voorburg", "Midden-Delfland",
    "Pijnacker-Nootdorp", "Capelle aan den IJssel", "Barendrecht", "Ridderkerk",
    "Albrandswaard", "Lansingerland", "Krimpen aan den IJssel", "Nissewaard",
    "Maassluis", "Goeree-Overflakkee", "Voorne aan Zee"
  ]
  ...
  const webPageSchema = {
    ...
    "description": "Professionele woningontruiming met laagste prijs garantie in Zuid-Holland",
    "url": "https://budgetontruiming.nl"
  }
  ...
  const howToSchema = {
    ...
    "description": "In 3 eenvoudige stappen naar een ontruimde woning zonder gedoe",
    "totalTime": "PT24H",
    "estimatedCost": {
      "@type": "MonetaryAmount",
      "currency": "EUR",
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <article className="container mx-auto px-4 py-12 lg:py-16">
          <section className="prose prose-lg max-w-none mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              Budget Ontruiming is uw specialist voor woningontruiming in Zuid-Holland. Wij zijn actief 
              in de regio's <strong>Haaglanden</strong> (Den Haag, Delft, Zoetermeer, Rijswijk, Wassenaar, Westland, 
              Pijnacker-Nootdorp, Leidschendam-Voorburg en Midden-Delfland) en <strong>Rijnmond</strong> (Rotterdam, 
              Schiedam, Vlaardingen, Capelle aan den IJssel, Barendrecht, Ridderkerk, Albrandswaard, Lansingerland, 
              Krimpen aan den IJssel, Nissewaard, Maassluis, Goeree-Overflakkee en Voorne aan Zee).
            </p>
            <p className="text-lg text-muted-foreground mb-4">
              <strong>Vindt u het elders goedkoper? Wij duiken onder die prijs!</strong> Dit is onze concrete garantie. 
              Krijgt u een lagere offerte van een andere ontruimingsbedrijf? Stuur deze naar ons op en wij gaan 
              eronder zitten. Zo weet u zeker dat u altijd de beste prijs betaalt voor uw woningontruiming.
            </p>
          </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="border rounded-lg p-6 bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                In de regio Haaglanden verzorgen wij professionele woningontruimingen in 9 gemeentes. 
                Van het drukke centrum van Den Haag tot de rustige wijken van Wassenaar.
              </p>
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li>• <a href="/woningontruiming-den-haag" className="hover:text-primary underline">Den Haag</a> - Alle wijken en postcodes (2500-2599)</li>
                <li>• <a href="/woningontruiming-delft" className="hover:text-primary underline">Delft</a> - Historisch centrum en nieuwbouw</li>
                <li>• <a href="/woningontruiming-zoetermeer" className="hover:text-primary underline">Zoetermeer</a> - Alle woonwijken en hoogbouw</li>
                <li>• <a href="/woningontruiming-wassenaar" className="hover:text-primary underline">Wassenaar</a> - Villa's en grotere woningen</li>
                <li>• <a href="/woningontruiming-westland" className="hover:text-primary underline">Westland</a> - Naaldwijk, Monster, 's-Gravenzande</li>
                <li>• <a href="/woningontruiming-rijswijk" className="hover:text-primary underline">Rijswijk</a> - Dichtbij Den Haag</li>
                <li>• <a href="/woningontruiming-pijnacker-nootdorp" className="hover:text-primary underline">Pijnacker-Nootdorp</a> - Voorsteden Den Haag</li>
                <li>• <a href="/woningontruiming-leidschendam-voorburg" className="hover:text-primary underline">Leidschendam-Voorburg</a> - Grensgebied</li>
                <li>• <a href="/woningontruiming-midden-delfland" className="hover:text-primary underline">Midden-Delfland</a> - Maasland, Schipluiden</li>
              </ul>
              <a href="/regio/haaglanden" className="text-primary font-semibold hover:underline">
            ...
            <div className="border rounded-lg p-6 bg-card">
              ...
              <p className="text-muted-foreground mb-4">
                De Rijnmond regio met 13 gemeentes. Van hoogbouw in Rotterdam tot dijkwoningen in Voorne aan Zee.
              </p>
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li>• <a href="/woningontruiming-rotterdam" className="hover:text-primary underline">Rotterdam</a> - Alle wijken (3000-3099)</li>
                <li>• <a href="/woningontruiming-schiedam" className="hover:text-primary underline">Schiedam</a> - Centrum en wijken</li>
                <li>• <a href="/woningontruiming-vlaardingen" className="hover:text-primary underline">Vlaardingen</a> - Haven en woongebieden</li>
                <li>• <a href="/woningontruiming-capelle-aan-den-ijssel" className="hover:text-primary underline">Capelle a/d IJssel</a> - Voorsteden</li>
                <li>• <a href="/woningontruiming-barendrecht" className="hover:text-primary underline">Barendrecht</a> - Groeiende gemeente</li>
                <li>• <a href="/woningontruiming-ridderkerk" className="hover:text-primary underline">Ridderkerk</a> - IJsselmonde</li>
                <li>• <a href="/woningontruiming-nissewaard" className="hover:text-primary underline">Nissewaard</a> - Spijkenisse e.o.</li>
                <li>• <a href="/woningontruiming-lansingerland" className="hover:text-primary underline">Lansingerland</a> - Berkel, Bleiswijk</li>
                <li>• <a href="/woningontruiming-albrandswaard" className="hover:text-primary underline">Albrandswaard</a> - Rhoon, Poortugaal</li>
                <li>• <a href="/woningontruiming-krimpen-aan-den-ijssel" className="hover:text-primary underline">Krimpen a/d IJssel</a> - Lek-gebied</li>
                <li>• <a href="/woningontruiming-maassluis" className="hover:text-primary underline">Maassluis</a> - Havenstad</li>
                <li>• <a href="/woningontruiming-goeree-overflakkee" className="hover:text-primary underline">Goeree-Overflakkee</a> - Eiland</li>
                <li>• <a href="/woningontruiming-voorne-aan-zee" className="hover:text-primary underline">Voorne aan Zee</a> - Kustgebied</li>
              </ul>
              <a href="/regio/rijnmond" className="text-primary font-semibold hover:underline">
                → Meer over Rijnmond
              </a>
            </div>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="border rounded-lg p-6 bg-card">
                ...
                <p className="text-muted-foreground">
                  Bij spoed vaak binnen 24 uur starten. In Rotterdam en Den Haag 24/7 bereikbaar.
                </p>
              </div>
        ...
        <GemeenteMap gemeenteNaam="Haaglanden & Rijnmond" postcodes="2500-2599, 3000-3099" />
