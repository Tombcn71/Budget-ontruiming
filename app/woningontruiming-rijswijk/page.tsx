...
export default function RijswijkPage() {
  ...
  const faqs = [
    ...
    {
      question: "Leveren jullie bezemschoon op voor woningcorporaties in Rijswijk?",
      answer:
      ...
      <main className="min-h-screen">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="hidden sm:block text-lg sm:text-xl text-white mb-6 leading-relaxed text-pretty">
                  Snelle en professionele woningontruiming in Rijswijk. Vindt u het elders goedkoper? Wij duiken onder die prijs! Vraag nu uw gratis offerte aan!
                </p>
        ...
        <article className="container mx-auto px-4 py-12 lg:py-16">
          <section className="prose prose-lg max-w-none mb-12">
            <h2 id="rijswijk-info" className="text-3xl font-bold text-foreground mb-6">
            ...
            {/* Wijken */}
            <div id="rijswijk-wijken" className="bg-muted/50 rounded-lg p-6 mb-8">
              <h3 className="font-bold text-xl text-foreground mb-4">Actief in alle wijken van Rijswijk:</h3>
          ...
          <section className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="border rounded-lg p-6 bg-card">
                ...
                <p className="text-muted-foreground">
                  Specialisatie in het ontruimen van hoogbouw appartementen. Wij gebruiken liften volgens huisregels en beschermen trappenhuizen.
                </p>
              </div>
        ...
        <section id="rijswijk-faq" className="bg-muted/50 py-12 lg:py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              Alles wat u moet weten over woningontruiming met Budget Ontruiming in Rijswijk
            </p>
