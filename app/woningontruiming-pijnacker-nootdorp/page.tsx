...
export const metadata: Metadata = {
  title:
    "Woningontruiming Pijnacker-Nootdorp | Laagste Prijs Garantie | Budgetontruiming.nl",
  description:
...
export default function PijnackerNootdorpPage() {
  ...
  const serviceSchema = {
    ...
    description:
      "Professionele woningontruiming in Pijnacker, Nootdorp en Delfgauw. Expertise in moderne gezinswoningen, appartementen en seniorenverhuizingen. Laagste prijs garantie.",
    knowsAbout: [
      ...
      <main className="min-h-screen">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="text-2xl sm:text-3xl lg:text-6xl font-bold text-white mb-3 lg:mb-6 leading-tight text-balance">
                  Woningontruiming Pijnacker-Nootdorp, met laagste prijs
                  garantie.
                </h1>
                ...
                <p className="hidden sm:block text-lg sm:text-xl text-white mb-6 leading-relaxed text-pretty">
                  Snelle en betaalbare woningontruiming in Pijnacker-Nootdorp.
                  Vindt u het elders goedkoper? Wij duiken onder die prijs!
        ...
        <article className="container mx-auto px-4 py-12 lg:py-16">
          <section className="prose prose-lg max-w-none mb-12">
            <h2
              id="pijnacker-nootdorp-info"
              className="text-3xl font-bold text-foreground mb-6">
              Woningontruiming in Pijnacker-Nootdorp
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Pijnacker-Nootdorp is een groeiende gemeente met moderne
              woonwijken en karakteristieke dorpskernen. Wij bieden
              professionele woningontruiming in alle delen van de gemeente tegen
              de laagste prijs, gegarandeerd.
            </p>

            {/* Wijken */}
            <div
              id="pijnacker-nootdorp-wijken"
              className="bg-muted/50 rounded-lg p-6 mb-8">
              <h3 className="font-bold text-xl text-foreground mb-4">
                Actief in alle kernen van Pijnacker-Nootdorp:
              </h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="border rounded-lg p-6 bg-card">
                ...
                <p className="text-muted-foreground">
                  ...
                  woningcorporaties. Perfect voor appartementen en huurwoningen.
                </p>
              </div>
              ...
              <div className="border rounded-lg p-6 bg-card">
                ...
                <p className="text-muted-foreground">
                  ...
                  garage, schuur en tuin. Alles wordt compleet ontruimd.
                </p>
              </div>
